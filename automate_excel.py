...
def check_value(insert_row, insert_value):
    ...
    # Checking if the month is alreay there in 3 column(checking only third column)
    # If there and updating value
    # else creating new column
    if currentMonth in sheet.cell(row=1, column=3).value:
        ...
        #First row
        first_row = sheet.cell(row=1, column=3, value=currentMonth + "'" + currentYear + ' MONTHLY RELEASE')
...
outputfile = "Siebel_GUI_Regression_Report_June'19_W23.xlsx"
